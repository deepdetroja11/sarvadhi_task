! function (a) {
    ...
    c3.generate({
        ...
        data: {
            columns: [
                ["data1", 0, 0, .2, .5, .6, 1.2, 2.5, 2.9, 4.5, 4.9, 5.2, 5.8, 6.5, 6.7, 7.4, 4.9, 6.4, 5.4, 10.8, 6.8, 5.2, 11.9],
                ["data2", 0, 0, 0, 0, .3, .2, .5, .6, 1.5, 1.8, 1.9, 2.5, 1.6, 3.8, 3.9, 3.6, 1.8, 1.8, 1.9, 2.8, 5.4, 7.8, 10.9]
            ],
            labels: !0,
            type: "spline",
            colors: {
